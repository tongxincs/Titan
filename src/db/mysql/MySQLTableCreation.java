...
/**
 * @author Tongxin90
 * Create the MySQL table and insert the data from the ticket master
 */
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			try {
				// establish the connection with MySQLDB
			...
			// establish the schema of the table
			...
			// Step 3: insert data, same as the SQL statement
			// Create a fake user
