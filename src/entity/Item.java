...
/**
 * @author Tongxin90
 * we use this class to collect all the items we want to select, and can get as JSON format	
 */
public class Item {
	...
	// we use this method to change the data we select to a JSON format
	...
	/**
	 * This is a builder pattern of Item, help to construct the item
	 */
